...
export default function Footer() {
  return (
    <div className="pt-10">
      ...
      <div
        class=" relative bg-white bg-no-repeat bg-contain pt-6"
        // style={{ backgroundImage: `url(${bgimg1})` }}
      >
        <div className="absolute  z-[1] top-0 bg-white w-full h-full" />
        <div class="relative z-[999] mx-auto w-full max-w-[1166px] px-4 xl:px-0 ">
          <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            <div class="md:w-[316px]">
              <p class="text-[18px] font-medium text-gray-800">
                <h1 class="text-gray-800 font-extrabold">
                  <span class="text-rose-600">YOUR</span>LOGO
                </h1>
              </p>
              <p class="mt-[18px] text-[15px] font-semibold text-gray-800">
              ...
              <div class="mt-[23px] flex">
                ...
                <div class="ml-[18px]">
                  <a
                    ...
                    class="font-Inter text-[14px] font-medium text-gray-800"
                  >
                    +91 1800123444
                  </a>
                  <p class="font-Inter text-[12px] font-medium text-gray-800">
                    Support Number
                  </p>
                </div>
              </div>
            ...
            <div class="mt-6 flex w-full flex-col justify-between text-gray-800 sm:flex-row md:mt-0 md:max-w-[341px]">
              <div class="">
          ...
          <div class="flex items-center justify-center pb-8 pt-[9px] md:py-8">
            <p class="text-[10px] font-normal text-gray-800 md:text-[12px]">
