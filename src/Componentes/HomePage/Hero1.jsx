...
export default function Hero1() {
  return (
    <div>
      <div class="relative bg-no-repeat bg-cover bg-opacity-50" style={{ backgroundImage: `url(${bggif1})` }}>
        ...
        <section class="relative z-[9999] w-full h-auto flex flex-col-reverse lg:flex-row-reverse  lg:px-16">
          ...
          <div class="w-full h-auto lg:w-[50%] flex flex-col mt-5 md:mt-10 lg:mt-20 ">
            <h1 class="text-3xl text-white font-semibold md:text-4xl lg:text-7xl [object Object] px-2 lg:px-0 text-center lg:text-left">
              Discover the Art of Perfect Astrology.
            </h1>
            ...
            <Link to={"/contact"} class="h-12 w-52 bg-[#432010] flex items-center justify-start rounded-full mt-5 p-1.5 mx-5 hover:opacity-80 transition ">
            ...
            <ul class="flex items-center text-white justify-start gap-5 lg:gap-12 h-28 mt-5 z-10">
